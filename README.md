...
| **DHT12** | Temperature & humidity sensor | Measures ambient temperature and relative humidity | [dth12.py frome tomas-fryza github](https://github.com/tomas-fryza/esp-micropython/blob/main/modules/dht12.py) |
...
|                              | VCC                 | 5 V  (outside of ESP32)           |  Provides 5V supply to dust sensor   |
| Power                       | VCC/VDD              | 3.3V             | Provides 3.3V supply to sensors        |
